    ...
    def __init__(self):
        ...
        self.menus = {
            ...
            "main": {
                ...
                "caption": """🌸 ⊹ **R O H I T  F Y T  K A  D E V T A** ⊹ 🌸
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_admin" and not is_admin(query.from_user.id):
    ...
    await query.message.edit_text(
        "❌ This menu action is no longer available.",
        reply_markup=get_back_keyboard(),
    )
